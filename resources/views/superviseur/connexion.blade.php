<x-layouts.auth titre="Connexion">

    <div x-data="connexionDelegation">
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="absolute top-6 start-6 flex items-center gap-3">
                        ...
                        <div class="leading-tight">
                            ...
                            <div class="text-[10px] font-semibold uppercase tracking-wider text-white-dark">MINPROFF</div>
                        </div>
                    </div>

                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Ouvrir une session</h1>
                            <p class="text-base font-bold leading-normal text-white-dark">Ministère, délégation régionale, départementale ou d'arrondissement.</p>
                        </div>
                        ...
                        @if (request()->query('session') === 'expiree')
                            <div class="mb-5 flex items-center rounded border border-warning bg-warning-light p-3.5 text-warning dark:bg-warning-dark-light">
                                <span class="ltr:pr-2 rtl:pl-2"><strong class="ltr:mr-1 rtl:ml-1">Session expirée.</strong>Reconnectez-vous pour reprendre.</span>
                            </div>
                        @endif
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="valider()">
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="email" x-model="email" type="email" autocomplete="email" required
                                           placeholder="minproff@mvoe.test" class="form-input ps-10 placeholder:text-white-dark" />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="mdp" x-model="motDePasse" type="password" autocomplete="current-password" required
                                           placeholder="••••••••" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                            ...
                            <div x-cloak x-show="erreur" class="flex items-center rounded border border-danger bg-danger-light p-3.5 text-danger dark:bg-danger-dark-light">
